      ...
      <div className='flex gap-4 mb-4'>
        ...
        <div className='flex flex-col justify-between min-w-0 flex-1'>
          <div>
            <div className='flex justify-between items-start gap-2'>
              ...
              <div className="flex gap-1">
                {importance !== undefined && (
                  <div className="flex items-center gap-1 text-[10px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-400/10 px-1.5 py-0.5 rounded-full border border-emerald-400/20" title="Importance Score">
            ...
            {/* Metadata Row */}
            <div className='flex flex-wrap items-center gap-2 mt-2 text-[10px] text-muted-foreground dark:text-slate-400 font-mono'>
               {salesCount !== undefined && salesCount > 0 && (
                  <span className="flex items-center gap-1 bg-blue-500/10 text-blue-700 dark:text-blue-400 px-1.5 py-0.5 rounded border border-blue-500/20" title="Estimated Popularity Index (Based on Ratings)">
