...
export default function HistoricalCases() {
  return (
    <div className='mt-12 bg-card/30 dark:bg-card border border-border rounded-3xl p-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        {cases.map((item, i) => (
          <div key={i} className='p-6 rounded-2xl bg-background/50 border border-border hover:border-indigo-500/30 transition-all group'>
            <div className='flex items-center justify-between mb-4'>
              <div className='p-2 rounded-lg bg-muted dark:bg-slate-900 text-muted-foreground'>
            ...
            <div className='space-y-3'>
              <div>
                <div className='text-[8px] font-bold text-muted-foreground uppercase mb-1'>Critical Failure</div>
            ...
            <button className='mt-6 w-full py-2 flex items-center justify-center gap-2 text-[10px] font-bold text-muted-foreground hover:text-foreground hover:bg-indigo-600 rounded-lg border border-border hover:border-indigo-600 transition-all'>
              OPEN_CASE_STUDY
