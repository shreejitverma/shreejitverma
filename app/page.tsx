...
export default function Home() {
  ...
  return (
    <div className='relative min-h-screen bg-transparent text-slate-700 dark:text-slate-300 font-sans selection:bg-cyan-500/30 overflow-x-hidden'>
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${
        scrolled ? 'backdrop-blur-md border-slate-200 dark:border-slate-800/50 bg-white/80 dark:bg-slate-950/80 h-16' : 'bg-transparent border-transparent h-20'
      }`}>
        <div className='max-w-7xl mx-auto px-6 h-full flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            <div className='relative w-10 h-10 rounded-full overflow-hidden border border-slate-300 dark:border-slate-700 shadow-lg shrink-0'>
              <Image 
            ...
            <div className='font-mono text-xl font-bold text-cyan-600 dark:text-cyan-400 tracking-tighter'>
          ...
          <div className='hidden lg:flex gap-8 text-sm font-medium'>
            ...
            <Link href='/value-investing' className='text-cyan-600 dark:text-cyan-400 font-bold hover:text-cyan-500 transition-colors'>Intelligence</Link>
          ...
          <div className='flex items-center gap-4'>
            ...
            {/* Mobile Menu Button */}
            <button 
              className='lg:hidden text-slate-700 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors'
        ...
        <div className={`lg:hidden absolute top-full left-0 right-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-all duration-300 overflow-hidden ${
          ...
          <div className='flex flex-col p-6 gap-4'>
            ...
            <Link 
              ...
              className='text-lg font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors'
              onClick={() => setIsMenuOpen(false)}
            >
      ...
      <main className='relative z-10'>
        ...
        <section className='pt-40 pb-20 px-6 max-w-7xl mx-auto'>
          <div className='flex flex-col md:flex-row items-center gap-12'>
            <div className='max-w-3xl flex-1 text-center md:text-left'>
              ...
              <h1 className='text-5xl md:text-7xl font-bold text-slate-900 dark:text-slate-100 mb-6 tracking-tight'>
                Quantitative <br />
              ...
              <div className='flex flex-wrap justify-center md:justify-start gap-4'>
                <a href='#experience' className='px-6 py-3 bg-slate-900 dark:bg-slate-100 text-slate-100 dark:text-slate-950 font-semibold rounded hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors'>
                  View Experience
                </a>
                <a href='#projects' className='px-6 py-3 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold rounded hover:border-cyan-500/50 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors'>
                  Key Projects
                </a>
              </div>
            </div>
            <div className='relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-slate-200 dark:border-slate-800 shadow-2xl shrink-0 order-first md:order-last'>
              <ProfileImage 
                src="/images/user-profile.png" 
                alt="Shreejit Verma" 
                className='object-cover'
              ...
              <div key={i} className='p-6 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 hover:border-cyan-500/30 transition-all'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {group.skills.split(', ').map((skill, j) => (
                    <span key={j} className='px-2 py-1 text-xs font-mono rounded bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800'>
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            {[
              ...
              >
                <div className='flex justify-between items-start mb-3'>
                  ...
                  <div className='flex items-center gap-3'>
                    <span className='text-xs font-mono text-cyan-600 dark:text-cyan-400 whitespace-nowrap'>{res.date}</span>
                    <Github className='w-5 h-5 text-slate-400 dark:text-slate-500 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors opacity-0 group-hover:opacity-100 shrink-0' />
                  </div>
                </div>
        ...
        <section id='books' className='py-20 max-w-7xl mx-auto px-6'>
          <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12'>
            ...
            <Link 
              href='/books' 
              className='px-6 py-3 bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 font-semibold rounded-lg border border-cyan-500/20 hover:bg-cyan-500 hover:text-slate-950 transition-all duration-300 w-fit'
            >
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 opacity-60'>
            {[
              ...
              <div key={i} className='aspect-[2/3] relative rounded-lg overflow-hidden border border-slate-200 dark:border-slate-800 grayscale hover:grayscale-0 transition-all'>
                <Image
                  src={book.src}
                  alt={book.title}
                  fill
        ...
        {/* Contact */}
        <footer className='py-12 border-t border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm'>
